...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cats_mapping = [
            ("metal-stand-busts", "Metal Stand Busts", "Premium metal stand busts featuring adjustable heights and luxury suede finishes.", "images.jfif"),
            ("multi-size-busts", "Multi-Size Busts", "Red, blue, and white suede bust collections in small, medium, and big sizes.", "images (1).jfif"),
            ("display-stands", "Display Stands", "Metal & PU display stands for earrings, bangles, rings, and bracelets.", "images (2).jfif"),
            ("display-trays", "Display Trays", "Premium suede display trays for earrings, rings, chains, and necklaces.", "images (3).jfif"),
            ("combo-sets", "Premium Combo Sets", "Ready-for-showroom display solutions, multi-ring props, and complete sets.", "images (4).jfif"),
            ("luxury-combos", "Luxury Combo Collection", "Premium Turkish designs and full display combo sets on wooden bases.", "images.jfif"),
        ]
        ...
        products_data = [
            ...
            {
                "category": cats["metal-stand-busts"],
            ...
            {
                "category": cats["multi-size-busts"],
